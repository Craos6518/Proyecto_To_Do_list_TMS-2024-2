...
// Mostrar tareas en el contenedor 'tareas-container'
function mostrarTareas(maxRows = 4) {
    ...
    const tasksPerRow = 2;
    let tareasAMostrar = maxRows * tasksPerRow;
    tareasAMostrar = Math.min(tareasAMostrar, tareas.length);
    ...
    loadMoreButton.onclick = () => {
        maxRows += 2;
        mostrarTareas(maxRows);
    };
}

// Simulación de tareas en localStorage para desarrollo
